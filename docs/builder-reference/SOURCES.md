...
- The page ranges above are the builder-focused slices used for the first-pass
  and expansion passes of the digests.
- Raw extractions from those slices belong in `staging/builder-reference/`.
- The staged text is local-only and ignored by git.
