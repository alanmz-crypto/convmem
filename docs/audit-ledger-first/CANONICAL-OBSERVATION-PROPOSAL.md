...
- The schema in this file is **provisional / end-state aspirational**.
- It must **not** be substituted for the Phase 0 shadow **event envelope**
  locked in draft Architecture #115. Phase 0 uses the Architecture envelope;
  canonical observation schema freeze is a later cutover Architecture item.
