...
- Inventory counts in this file (e.g. 192 Chroma-only, 3,448 legacy decisions,
  21,420 legacy units) are **snapshot values** from the audit runtime — re-measure
  before any migration decision; do not treat them as live truth.
