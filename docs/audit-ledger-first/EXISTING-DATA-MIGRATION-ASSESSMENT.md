...
- Re-run and **runtime-stamp** any inventory counts before using them in Execute
  or migration planning (doctor/brief dates + command output).
- Human classification of ambiguous legacy/decision rows and stable ID mapping
  remain **later gates** — not Phase 0 deliverables.
