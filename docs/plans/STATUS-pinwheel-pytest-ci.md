...
| Pinwheel implementation | Not started; this branch is planning-only |
...
| Cursor CI implementation | Not started | Ryan authorization |
...
- [ ] Cursor selects the exact pytest patch version from a fresh Python 3.12
  install and records it in the workflow contract.
- [ ] Cursor adds `tests/test_ci_contract.py`, the checker, and the manifest
  entry atomically.
- [ ] Focused tests and a clean local baseline pass.
- [ ] Ryan authorizes disposable Pinwheel controls and ordinary PR evidence.
