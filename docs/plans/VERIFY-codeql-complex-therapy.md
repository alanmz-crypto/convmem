...
| V0d | Ryan authorized external Execute | Grant A explicitly names only ruleset `19156572`, the final five-context set, and the normal positive control; Grant B remains separately withheld | PASS — Grant A recorded; Grant B not issued |
