...
replacement, never a mixed or missing authority set. P1 must also publish
versioned canonicalization golden vectors and rerun them across supported
serialization implementations/library changes.
