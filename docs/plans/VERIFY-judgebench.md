...
| CHK-007 corpus-backed conformance | No calibration calls were run and no provider result exists; G3 is already merged/locked at `5f1a3ef` | **PARTIAL** — Phase A review/PR/merge, Ryan's separate 60-call authorization (3 candidates × 20 calibration cases), and calibration execution remain required |
