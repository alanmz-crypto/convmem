...
**Subject / tip:** `feat/2026-07-24-codex-planning-cursor-execution` @ `SUBJECT_TIP_PLACEHOLDER`
...
| `subject_tip_sha` | `SUBJECT_TIP_PLACEHOLDER` |
...
|----|-------|---------------------------|
| V0a | Subject tip and implementation base resolve; base contains the Ryan-approved Architecture, Execution Plan, and this stub | **PASS** — base `0096d56` has Architecture/Execution/VERIFY; tip `SUBJECT_TIP_PLACEHOLDER` |
...
|----|-------|--------------------|
| V1a | Every changed path is in the Execution Plan's authored, generated, or evidence-only file set | **PASS** — `git diff --name-only 0096d56...SUBJECT_TIP_PLACEHOLDER` matches authored/generated/evidence set only |
...
subject tip: SUBJECT_TIP_PLACEHOLDER
