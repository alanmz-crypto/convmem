...
**P0 fixes (Layers 0, 3, 7, 9, 10):** ~45 lines of code + 2 config toggles + 1 new file. Impact: fixes the "current plan arc" retrieval (P0d) AND removes ~2,100 duplicate/low-quality units (P0a-c).
