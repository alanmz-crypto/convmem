...
- [ ] Read `ARCHITECTURE-agent-run-ledger.md` and `EXECUTION-agent-run-ledger.md` on branch `plan/2026-08-20-agent-run-ledger`
- [ ] `convmem work start feat agent-run-ledger` (creates `feat/2026-08-20-agent-run-ledger`)
- [ ] State Goal / role / system state / next action per STATUS
- [ ] Start with T0 (hook contract fixture) before writing capture code
