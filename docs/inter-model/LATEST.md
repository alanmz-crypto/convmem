...
**Updated:** 2026-08-30 (R2b Corrective VII — Kiro re-review handoff)

## Current routing

- **[Arc R2b Capture Authorization] Corrective VII — READY FOR KIRO RE-REVIEW (2026-08-30, Cursor → Kiro):** Who/What: Cursor closed Kiro VI Break 2 by removing module-global `_MUTATION_GUARD` and making `_SealedStore._guard_mutation` frame-based (same vault-module + `co_name` check as ledger guards). When: frozen tip `ea7bc9d` on branch `fix/2026-08-30-2026-08-30-r2b-v2-corrective-vi`, pushed. Why: VI FAIL — `_MUTATION_GUARD[0].depth = 5` reopened registry writes; VII removes that surface. How: 139/139 R2b pytest PASS at tip; Break 1 (ledger injection) unchanged from VI PASS; review in detached worktree at exact SHA only. **Prior verdicts:** V FAIL @ `81becac`; VI FAIL @ `5ccb6be`. **Does not authorize merge, pylint baseline ratification, or I4–I8 advance until Kiro PASS.** **Resume state:** `NOT_STARTED`. Evidence: [`KIRO-2026-08-30-r2b-v2-corrective-vii-handoff.md`](KIRO-2026-08-30-r2b-v2-corrective-vii-handoff.md).

- **[Arc Project-state reconciliation only] CANONICAL ROUTING CORRECTIVE LANDED / CLOSED (2026-08-30):** Who/What: Codex reconciled live GitHub state at `main@e930ae4c` into the cross-arc rollup, current handoff pointer, and Recovery/R2b arc briefs; corrective commit `ad9a9b6a039768c85b704f2bf17034c2605d63fa` squash-merged via PR #253 as `a924d3887329dd51f1e0ac917f8ab21bae513c57`. When: after Recovery T3, CG-2 Execute-close, watch OOM, relocation, and writer-attestation work landed while canonical routing lagged. Why: fresh agents must distinguish landed, branch-only, blocked, unauthorized, and superseded states. How: documentation-only four-file correction; no runtime, architecture, experiment, production, grant, activation, or provenance deletion. **Resume state:** `CLOSED`; no further reconciliation work. Evidence: [`CODEX-2026-08-30-project-state-reconciliation-handoff.md`](CODEX-2026-08-30-project-state-reconciliation-handoff.md).

- **R2b v2 I1–I3 — ACTIVE CORRECTIVE / AWAITING KIRO RE-REVIEW (2026-08-30):** Who/What: Corrective VII carrier on `fix/2026-08-30-2026-08-30-r2b-v2-corrective-vi` at `ea7bc9d` (lineage from PR #252 / Corrective V base `81becac` + VI + VII). When: after Kiro VI FAIL @ `5ccb6be` (Break 2 `_MUTATION_GUARD` bypass). Why: I1–I3 needs independent PASS on one frozen tip before Ryan merge decision. How: Kiro re-review only — detached worktree at `ea7bc9d`; no merge, I4–I8, live gate, duration, packet, grant, or capture authority until PASS. Draft PR [#252](https://github.com/alanmz-crypto/convmem/pull/252) remains open; re-freeze coordinates in Kiro handoff. Evidence: [`KIRO-2026-08-30-r2b-v2-corrective-vii-handoff.md`](KIRO-2026-08-30-r2b-v2-corrective-vii-handoff.md) · [`STATUS-r2b-capture-auth.md`](../plans/STATUS-r2b-capture-auth.md).

- **[Arc Naturalistic ConvMem product-value evaluation] G1–G4 LANDED / G5 NOT AUTHORIZED (2026-08-30):** Who/What: Combined methodology PR #255 is squash-merged to `main` as `787a6ef8077f099820b8ab903777dd67951c9bb7`; Kiro independently PASSed exact G4 implementation SHA `fa7d68b4b272a9802b0983c708800d6953ec45f8`, and the reviewed G4 implementation bytes remain unchanged. When: after focused G1–G4 verification reproduced **98 passed + 8 subtests**, focused Pylint **10.00/10**, exact repository Pylint regression passed, and GitHub pytest plus both CodeQL analyses passed. Why: land the pre-live methodology substrate without mistaking it for product evidence or study authority. How: architecture, execution plan, contracts, adjudication/probe scaffolds, bounded analysis, and tests are now on `main`; Ryan retains every later grant. **G5 dry-run, Agent A/B, episode collection, target adjudication, recapture, product conclusions, G6, and live-study work remain unauthorized.** Evidence: [PR #255](https://github.com/alanmz-crypto/convmem/pull/255) · [`CODEX-2026-08-30-naturalistic-product-value-g4-handoff.md`](CODEX-2026-08-30-naturalistic-product-value-g4-handoff.md) · [`STATUS-naturalistic-product-value.md`](../plans/STATUS-naturalistic-product-value.md) · [`ARCHITECTURE-naturalistic-product-value.md`](../plans/ARCHITECTURE-naturalistic-product-value.md) · [`EXECUTION-naturalistic-product-value.md`](../plans/EXECUTION-naturalistic-product-value.md).

- **Portland baseline — RERUN3 SEED-GENERATION FAILURE (2026-08-30):** Who/What: Protocol-v3 branch `experiment/2026-08-30-portland-rerun3-v3@9ba72378` produced one candidate that failed K8→K9 supersession and K10 provenance. When: after the pre-v3 seed was explicitly superseded as non-admissible. Why: prevent a failed seed or preserved pre-v3 packet from routing Agent B. How: no retry and no Agent B execution are authorized; preserve evidence, with no product verdict and no `main` landing.

- **[Arc Recovery Authority] T3 LANDED / NON-SERVING (2026-08-27):** Who/What: Cursor's scratch-only bulk-recovery workflow landed via PR #238 at `d250feb2bbbf81e2c3dd8513d79fb0e2140266a3`. When: after T1/T2 and exact-tip verification. Why: prepare one isolated replacement candidate from exact v3 backup authority without touching live state. How: T3 is on `main`; T4 remains unstarted and **NOT AUTHORIZED**, while V4k remains separately blocked. No live recovery, replacement, activation, or serving authority follows. Evidence: [`STATUS-recovery-authority.md`](../plans/STATUS-recovery-authority.md).

- **CG-2 Design A — EXECUTE-CLOSE LANDED / PRODUCTION UNAUTHORIZED (2026-08-29):** Who/What: Cursor's accepted D7 runtime, tests, VERIFY, and formal bundle landed through PR #250 at `e930ae4c2fb67eabbfa570f7caacda8d9ddac79d`. When: transplanted onto current main after independent landing review. Why: close the hermetic Execute package without carrying historical branch noise. How: code/evidence is on `main`; production D0/D1, `G_rb`/`G_canary`, V8c, fence/pointer, cutover, activation, retirement, GC, Shadow, and R2b remain unauthorized. Separate retained-reference-v2 corrective work is branch-only.

- **Watch OOM subprocess cap — LANDED / CLOSED (2026-08-29):** Who/What: the child-process memory scope corrective landed via PR #245 at `3dd355a50c1498aadc94b143f6997d2e005016be`. Why: an already-landed corrective must not remain a READY_FOR_PR route. How: the prior Kiro handoff is preserved as historical evidence; no watch PR work remains.
...
- **[Arc R2b Capture Authorization] v2 clean-base recovery candidate (2026-08-28):** Who/What: Cursor transplanted the accepted v2 normative plan (`b7f4764bde8598b654199cd6d5e0d4098c57081c`, reviewed base `89a7e045b130f005f57539478d9a180cbea905df`) onto current `origin/main` `872a0e483dd5eff09ccaef3c655af82f5e81e92e` (#243 writer-attestation hardening). When: docs-only branch `docs/2026-08-28-r2b-v2-clean-base`; no runtime action occurred. Why: v1 timing-only behavior is incompatible with a continuously mutating live source; the accepted plan must land on the hardened writer-gate substrate. How: future R2b must hold one live exclusive writer-gate lease across trusted snapshot → packet draft/ACCEPT → materialization → remaining-budget proof → ACCEPT AND GRANT → one capture → final source recomputation → close evidence → release → release evidence. Zero-bypass coverage, concrete durations, implementation, activation, and all live authority remain pending Ryan. **900 seconds is not ratified.** Old v1 manifests and quarantined runs `2026-07-21-r2b-capture-01` / `2026-08-27-r2b-capture-02` are not upgraded or reused. Historical accepted branch `docs/2026-08-27-r2b-v2-writer-gate-normative` / PR #241 remain provenance until Ryan decides disposition. **Resume state:** Kiro narrow clean-base review. Merge reading: [`STATUS-r2b-capture-auth.md`](../plans/STATUS-r2b-capture-auth.md) · [`ARCHITECTURE-r2b-mutable-source-quiescence-v2.md`](../plans/ARCHITECTURE-r2b-mutable-source-quiescence-v2.md) · [`EXECUTION-2026-08-27-r2b-v2-quiescence.md`](../plans/EXECUTION-2026-08-27-r2b-v2-quiescence.md) · [`VERIFY-r2b-v2-quiescence.md`](../plans/VERIFY-r2b-v2-quiescence.md).
