...
**Updated:** 2026-08-16 (Kryptonite closeout verified; Pinwheel planning package reviewed)
...
- **Pinwheel Pytest CI — planning READY, implementation unauthorized (2026-08-16):** Who/What: Codex planning package for exact pytest pinning, version logs, workflow-contract preservation, and explicit 16-entry critical-manifest collection. When: based on live `main` `bc83c85d`; Kiro and ChatGPT both PASS with conditions. Why: close the two Kryptonite residuals without changing Protect Main or CodeQL. How: Ryan must authorize Cursor implementation and any disposable PRs; exact pytest version comes from fresh Python 3.12 evidence; collection passes only on per-module pytest exit code 0. Merge reading: [`STATUS-pinwheel-pytest-ci.md`](../plans/STATUS-pinwheel-pytest-ci.md) · [`ARCHITECTURE-pinwheel-pytest-ci.md`](../plans/ARCHITECTURE-pinwheel-pytest-ci.md) · [`EXECUTION-pinwheel-pytest-ci.md`](../plans/EXECUTION-pinwheel-pytest-ci.md) · [`VERIFY-pinwheel-pytest-ci.md`](../plans/VERIFY-pinwheel-pytest-ci.md) · [`CODEX-2026-08-15-pinwheel-pytest-ci-handoff.md`](CODEX-2026-08-15-pinwheel-pytest-ci-handoff.md)
