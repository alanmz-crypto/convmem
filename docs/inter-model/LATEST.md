...
- **CI Behavioral Merge Gate — MERGED (2026-08-15, [#187](https://github.com/alanmz-crypto/convmem/pull/187)):** Who/What: hermetic pytest job in GitHub Actions; `Protect Main` ruleset requires `pytest (3.12)` alongside `pylint (3.12)`. When: squash-merged `c2c6429` 2026-08-15. Why: gate merge on full hermetic suite. How: `pylint.yml` pytest job + ruleset update. Closeout handoff on `plan/2026-08-15-ci-behavioral-merge-gate-closeout` may still have Ryan BLOCKED items — see [`CODEX-2026-08-15-ci-behavioral-merge-gate-closeout-handoff.md`](CODEX-2026-08-15-ci-behavioral-merge-gate-closeout-handoff.md).
