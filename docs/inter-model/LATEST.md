...
- **CodeQL Complex Therapy — SHA-BOUND HANDOFF READY FOR KIRO/Ryan REVIEW (2026-08-16, `plan/2026-08-16-codeql-complex-therapy`):** Who/What: Codex removed the tracked-workflow fallback, tightened negative-control causality, documented the required-check latency decision, and added an explicit handoff naming package SHA `45046fafd0aa918042a89ae7e9a85fb707ce55d1`. When: planning evidence remains Protect Main `19156572` and PR #197 head `740424884f8921f1586f6b82648a0a290be40836`; no implementation or disposable PR exists. Why: review must bind to a copy-pasteable package identity and Ryan must consciously accept CodeQL wait/queue cost on ordinary PRs. How: Kiro reviews the named package plus additive handoff carrier; Ryan then decides Execute separately. [`CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md`](CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md) · [`ARCHITECTURE-codeql-complex-therapy.md`](../plans/ARCHITECTURE-codeql-complex-therapy.md) · [`EXECUTION-codeql-complex-therapy.md`](../plans/EXECUTION-codeql-complex-therapy.md) · [`VERIFY-codeql-complex-therapy.md`](../plans/VERIFY-codeql-complex-therapy.md) · [`STATUS-codeql-complex-therapy.md`](../plans/STATUS-codeql-complex-therapy.md). **Resume state:** `HANDOFF READY` — Kiro adversarial review next; Ryan Execute not authorized.
