...
- **[Arc Project-state reconciliation only] CANONICAL ROUTING CORRECTIVE READY_FOR_PR (2026-08-30, Codex → Ryan):** Who/What: Codex reconciled live GitHub state at `main@e930ae4c` into the cross-arc rollup, current handoff pointer, and Recovery/R2b arc briefs; corrective commit `ad9a9b6a039768c85b704f2bf17034c2605d63fa` is pushed on `docs/2026-08-30-project-state-reconciliation`. When: after Recovery T3, CG-2 Execute-close, watch OOM, relocation, and writer-attestation work landed while canonical routing lagged. Why: fresh agents must distinguish landed, branch-only, blocked, unauthorized, and superseded states. How: documentation-only four-file correction; no runtime, architecture, experiment, production, grant, merge, activation, or provenance deletion. **Resume state:** `READY_FOR_PR`; Ryan reviews the comparison and authorizes PR creation if accepted. Evidence: [`CODEX-2026-08-30-project-state-reconciliation-handoff.md`](CODEX-2026-08-30-project-state-reconciliation-handoff.md).
