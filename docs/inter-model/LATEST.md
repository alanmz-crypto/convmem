...
**Updated:** 2026-08-27 (Stale arcs delegation handoff for ChatGPT; CG-2 Design A landed via PR #239)

- **[Ad-hoc] Stale arcs delegation handoff — AUTHORIZED, NOT_STARTED (2026-08-27):** Who/What: ChatGPT handoff to investigate and delegate the three stale arcs (JudgeBench, R2b capture auth, Shadow Phase 0 — all >18d stale, all code on `main`, all governance-gated). When: authored 2026-08-27 on branch `docs/2026-08-27-stale-arcs-chatgpt-delegation-handoff` (pushed, tip `25ab9dd`). Why: unblock governance ceremonies that have been paused since 2026-08-09; no CG-2 conflict. How: ChatGPT reads the handoff, investigates STATUS files, delegates next steps to correct lanes (Ryan for grants, Codex for packet/evidence prep). **Next: ChatGPT picks up handoff and issues delegations.** Evidence: [`CHATGPT-2026-08-27-stale-arcs-delegation-handoff.md`](CHATGPT-2026-08-27-stale-arcs-delegation-handoff.md).
