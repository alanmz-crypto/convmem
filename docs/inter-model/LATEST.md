...
**Updated:** 2026-07-20 (HITL charter: Copilot lifecycle corrective — valid Mermaid, separate Copilot/Codex rows, defer excluded, fitness test — awaiting Copilot audit + Kiro sign-off)
**Live counts:** run `convmem brief` — do not trust stale numbers here.

## Active handoff

- **HITL charter — Copilot lifecycle corrective (2026-07-20):** Precision repairs on `dc65fef`: valid Mermaid (TD flowchart, decision gates, `<br/>` labels); Sol-High separated from GitHub Copilot audit lane in full charter + compact slice; `defer` excluded as a valid Sol-High verdict; Auth-R1…R8 demoted to embedding-eval worked example; DeepSeek R1 vs Auth-R1 disambiguated; Copilot audit lane and OpenAI Codex are separate AGENT-ROLES.md rows; fitness test added; idempotence verified. Canonical: [`TEAM-CHARTER-2026-07-06.md`](TEAM-CHARTER-2026-07-06.md); successor post: [`CURSOR-2026-07-20-hitl-charter-copilot-lifecycle.md`](CURSOR-2026-07-20-hitl-charter-copilot-lifecycle.md); original handoff at `0d2cbf7`: [`CURSOR-2026-07-19-hitl-charter-delegation-sol-high.md`](CURSOR-2026-07-19-hitl-charter-delegation-sol-high.md). **Deploy blocked** — awaiting GitHub Copilot audit + Kiro sign-off on same tip SHA. PR #52 independent. Branch: `docs/2026-07-19-hitl-charter-delegation-sol-high-gate`.
