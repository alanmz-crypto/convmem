...
- **Claude Watch Parity — NEXT: RYAN GATE 1 PR DECISION:** Start with the [PR decision handoff](CODEX-2026-09-18-claude-watch-parity-gate1-pr-decision-handoff.md). Kiro reports exact-tip Gate 1 code PASS at `ab8a9e16`; [PR #310](https://github.com/alanmz-crypto/convmem/pull/310) is open, not merged, and final pytest CI was pending at handoff. Ryan verifies final CI and the cross-arc R2b inventory rebind, then decides merge. The [Gate 2 plan](CODEX-2026-09-18-claude-watch-parity-gate2-execute.md) separately received Kiro PASS at `a811f58`; Cursor may implement its isolated route only after Gate 1 lands and Ryan grants bounded Execute. Live canary stays `NOT_RUN`; production routing and watch/source wiring remain Ryan-gated. See the [arc brief](../plans/STATUS-claude-watch-parity.md).
