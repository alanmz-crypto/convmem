...
- **R2a toml-fix + R2b plan (2026-07-20):** Regenerated shadows under run `2026-07-20-r2a-nomic-vs-mxbai-toml-fix`. **R2b:** [`../plans/EXECUTION-2026-07-20-r2b-capture.md`](../plans/EXECUTION-2026-07-20-r2b-capture.md); VERIFY filled [`../plans/VERIFY-r2b-capture.md`](../plans/VERIFY-r2b-capture.md) (T1). **T2 needed:** Ryan grant + choose schema option A (phase `r2b`) or B (placeholders). **Live R2b capture not authorized.**
