...
**Updated:** 2026-08-30 (R2b Corrective VII Kiro PASS / Ryan GATE; Naturalistic G5C Cursor grant / not started)

## Current routing

- **[Arc Naturalistic ConvMem product-value evaluation] G5C IMPLEMENTED / READY_FOR_KIRO_REVIEW (2026-08-31, Cursor):** Who/What: Cursor completed bounded G5C corrective on branch `fix/2026-08-30-naturalistic-g5c-corrective` at `a77b50f7721862b119fc045f2eec24f40df74416` (carrier `c089070` is ancestor). When: after Ryan-granted Cursor handoff `9a83ae9`. Why: repair G5 composition — structural T0 completeness, T0–T10 ledger, bounds/precedence/replay. How: 116 focused pytest green; 34 dry-run scenarios; synthetic only — not product evidence. **Resume state:** `READY_FOR_KIRO_REVIEW`. **Next:** Kiro exact-tip review; Ryan merge after PASS. G6 remains Ryan-gated. Evidence: [`CURSOR-2026-08-31-naturalistic-g5c-kiro-review-handoff.md`](CURSOR-2026-08-31-naturalistic-g5c-kiro-review-handoff.md) · `git diff origin/main...a77b50f -- eval_naturalistic/ tests/test_naturalistic_*.py`
...
- **R2b v2 I1–I3 — KIRO PASS @ `ea7bc9d` / RYAN GATE (2026-08-30):** Who/What: Corrective VII carrier on `fix/2026-08-30-2026-08-30-r2b-v2-corrective-vi`; Kiro independent PASS on authority boundary (all 8 dimensions). When: after V FAIL @ `81becac`, VI FAIL @ `5ccb6be`, VII fix @ `ea7bc9d`. Why: I1–I3 closure verified before merge. How: Ryan merge/hold on [#260](https://github.com/alanmz-crypto/convmem/pull/260); re-freeze coordinates `ea7bc9d`; optional Copilot audit per charter. **No live capture, I4–I8, duration, packet, or grant authority.** Evidence: [`KIRO-2026-08-30-r2b-v2-corrective-vii-handoff.md`](KIRO-2026-08-30-r2b-v2-corrective-vii-handoff.md) · [`STATUS-r2b-capture-auth.md`](../plans/STATUS-r2b-capture-auth.md).

- **[Arc Naturalistic ConvMem product-value evaluation] G5 LANDED / GATE C / BOUNDED G5C CURSOR GRANT / NOT STARTED / G6 CLOSED (2026-08-30):** Who/What: Ryan granted Cursor the strict G5C corrective allowlist against accepted carrier `c089070` (Kiro-PASSed design `b6a1ccf`, wording-only `fde840b`). When: after design-only acceptance; no repository change was part of the grant itself. Why: repair only the methodology composition defect—structural T0 completeness, immutable opportunity authority, separate capture/evaluability, valid-only bounds, precedence, paired replay, and individual T0–T10 ledger—without advancing toward live evaluation. How: Cursor creates `fix/2026-08-30-naturalistic-g5c-corrective`, modifies only named evaluator/fixture/test files, runs synthetic verification, pushes exact evidence, and stops for fresh Kiro review. **Resume state:** `NOT_STARTED`. **Next:** Cursor bounded implementation. No G6/T0, parameter freeze, natural evidence/corpus access, Agent A/B, live scoring, product interpretation, or merge authority. Evidence: [Cursor handoff](CODEX-2026-08-30-naturalistic-g5c-cursor-handoff.md) · [`STATUS-naturalistic-product-value.md`](../plans/STATUS-naturalistic-product-value.md) · [execution](../plans/EXECUTION-naturalistic-product-value.md)
