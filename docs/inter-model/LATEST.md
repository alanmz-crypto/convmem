...
- **CodeQL Complex Therapy — FINAL CLEANUP READY FOR KIRO/Ryan REVIEW (2026-08-16, `plan/2026-08-16-codeql-complex-therapy`):** Who/What: Codex removed the tracked-workflow fallback and tightened the negative-control causality requirement. When: planning evidence remains Protect Main `19156572` and PR #197 head `740424884f8921f1586f6b82648a0a290be40836`; no implementation or disposable PR exists. Why: the only currently authorized fixture must be isolated, and CodeQL must be independently unsatisfied while pre-existing Pylint/Pytest remain successful. How: an ineffective isolated fixture now closes/deletes with a new Ryan authorization required for any different fixture; Execute remains unauthorized. [`ARCHITECTURE-codeql-complex-therapy.md`](../plans/ARCHITECTURE-codeql-complex-therapy.md) · [`EXECUTION-codeql-complex-therapy.md`](../plans/EXECUTION-codeql-complex-therapy.md) · [`VERIFY-codeql-complex-therapy.md`](../plans/VERIFY-codeql-complex-therapy.md) · [`STATUS-codeql-complex-therapy.md`](../plans/STATUS-codeql-complex-therapy.md). **Resume state:** `FINAL CLEANUP READY` — Kiro adversarial review next; Ryan Execute not authorized; final full review SHA is supplied in the Codex handoff.
