...
**Updated:** 2026-07-19 (Gate 1 merged and pinned)
**Live counts:** run `convmem brief` — do not trust stale numbers here.

## Active handoff

- **Gate 1 embedding-eval harness (2026-07-19) — merged and pinned:** PR [#44](https://github.com/alanmz-crypto/convmem/pull/44) squash-merged as immutable Gate 1 harness version `3b2790f50414f0445c35748e52f849c6276839f7` on `main`. Pylint and Approval Agent passed; Codex independent diff + full suite passed (626 passed, 45 subtests). The final correction preserves doctor catch-all containment and schema-incompatible SQLite WARN behavior. Post: [`CURSOR-2026-07-19-gate1-correction.md`](CURSOR-2026-07-19-gate1-correction.md). Runbook: [`EXECUTION-embedding-model-eval.md`](../plans/EXECUTION-embedding-model-eval.md). **Gate 2 remains blocked** — no real pilot / live capture/eval until Ryan authorizes.
