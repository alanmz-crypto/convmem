...
**Updated:** 2026-08-30 (Naturalistic product-value G4 — READY_FOR_REVIEW)

- **[Arc Naturalistic ConvMem product-value evaluation] G4 READY_FOR_REVIEW (2026-08-30, Codex → Kiro):** Who/What: Codex corrected the bounded G4 analysis/statistical machinery after the original `0e191c3` freeze silently accepted malformed, duplicate, and orphaned score inputs. When: exact implementation SHA `fa7d68b4b272a9802b0983c708800d6953ec45f8`, pushed on `feat/2026-08-30-naturalistic-product-value-g4`; the handoff commit is carrier-only. Why: invalid or ambiguous evidence must not produce trustworthy-looking opportunity or conditional-effect results. How: strict finite bounds, duplicate/orphan rejection, separate target-opportunity/evaluability counts and density, explicit scorer independence/tolerance, immutable information slots, and adversarial synthetic tests. Focused G1–G4 naturalistic suite **98 passed + 8 subtests**; changed-file Pylint **10.00/10**; inherited G1–G3 repo-lint debt, an unrelated full-suite Click failure, and the missing arc STATUS brief are recorded caveats. **Next: Kiro exact-SHA `PASS`/`FAIL`, then Ryan disposition. G5, PR/merge, and live-study work remain unauthorized.** Evidence: [`CODEX-2026-08-30-naturalistic-product-value-g4-handoff.md`](CODEX-2026-08-30-naturalistic-product-value-g4-handoff.md) · [`ARCHITECTURE-naturalistic-product-value.md`](../plans/ARCHITECTURE-naturalistic-product-value.md) · [`EXECUTION-naturalistic-product-value.md`](../plans/EXECUTION-naturalistic-product-value.md).
