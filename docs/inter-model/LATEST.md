...
**Updated:** 2026-07-24 (Shadow Ledger Phase 0 Architecture drafted; salvage for one-workspace takeover)
**Live counts:** run `convmem brief` — do not trust stale numbers here.

## Active handoff

- **Shadow Ledger Phase 0 — Architecture drafted, awaiting Ryan HITL (2026-07-24):** Who/What: Codex authored draft Architecture [#115](https://github.com/alanmz-crypto/convmem/pull/115) @ `c9a5c70` (Option B opt-in ChromaStore mutation observer; Chroma still Tier-1; eleven decisions locked). When: after Qwen YELLOW audit + ChatGPT work order + Cursor packaging. Why: system direction before any Execute. How: review Architecture on [#115](https://github.com/alanmz-crypto/convmem/pull/115) (`docs/plans/ARCHITECTURE-shadow-ledger-phase0.md` @ `c9a5c70`); takeover context [`CURSOR-2026-07-24-shadow-ledger-phase0-recon-takeover.md`](CURSOR-2026-07-24-shadow-ledger-phase0-recon-takeover.md); audit baseline under [`../audit-ledger-first/`](../audit-ledger-first/) (corrections still required per #115). **Cursor Execute / production hooks prohibited** until Ryan HITL + later Execution plan. No Codex workspace required — GitHub is enough.

- **Shadow Ledger salvage / one-workspace takeover (2026-07-24):** Who/What: Cursor recon salvaged local-only audit + ChatGPT handoff + coordination board onto a dedicated docs PR (not the research-pack branch). When: after multi-chat coordination. Why: close sibling chats without losing residue. How: open the salvage PR linked from the takeover brief; discard duplicate dirty copies on `docs/2026-07-24-research-pack-backup-neutral` working tree after GitHub has them.

- **Research pack for cloud Claude/ChatGPT (2026-07-24):** Branch [`docs/2026-07-24-research-pack-backup-neutral`](https://github.com/alanmz-crypto/convmem/tree/docs/2026-07-24-research-pack-backup-neutral/docs/inter-model/research-pack-2026-07-24-backup-neutral) / merged via [#114](https://github.com/alanmz-crypto/convmem/pull/114). Who/What: Cursor frozen attachments + handoffs so max models can research (1) complete-data backup close decisions and (2) Neutral/Office Gate-0 + ledger-first appetite. When: pack PR merged to main. Why: those two tracks remain owner-decision blockers; Codex↔Cursor lane (#109/#112) stays closed. How: open [README](research-pack-2026-07-24-backup-neutral/README.md); paste `CLAUDE-HANDOFF.md` / `CHATGPT-HANDOFF.md`; browse `attachments/`. **Does not authorize** Office coding, Neutral extraction, or live Restic rollout.
