...
- **CG-2 authority migration — MERGED (#186); V8b grant PASS; soak COMPLETED + Ryan-accepted 2026-08-21:** Who/What: T1–T5 serving authority, source reconciliation, logical accounting, mixed-mode proof, rehearsal + VERIFY/RUNBOOK on `main` (`2f427fc`, 2026-08-15). Soak completion separately accepted 2026-08-21 (watch PID 955623 continuous from 2026-08-18 02:12:54 CDT; final eval-retrieval no-regression at 2026-08-21T08:17Z). Why: gateway proven on live corpus before any generational owner grant. How: see VERIFY soak-completion evidence. **V8a PENDING.** **V8b PASS** (grant only — not redefined as completion). **V8c PENDING.** **Resume state:** soak completion **closed**; arc remains open for V8a and later owner-gated work — **not** authorized for first owner, activation manifest, GC, Shadow, or R2b. Desktop checklist: `~/Desktop/CG2-after-soak-checklist.md` (not in repo; paper-close steps still apply when Ryan opens a PR).
