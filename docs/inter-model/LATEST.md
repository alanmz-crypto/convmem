...
**Updated:** 2026-07-19 (Gate 1 correction post + Response TL;DR protocol + practice-site bug triage)
**Live counts:** run `convmem brief` — do not trust stale numbers here.

## Active handoff

- **Gate 1 embedding-eval correction (2026-07-19):** Cursor pushed tip `02ae7e8` on `feat/2026-07-19-embed-eval-harness` under Ryan authorization + five Codex binding constraints. Post: [`CURSOR-2026-07-19-gate1-correction.md`](CURSOR-2026-07-19-gate1-correction.md). Runbook: [`EXECUTION-embedding-model-eval.md`](../plans/EXECUTION-embedding-model-eval.md). **Next:** Codex targeted re-verify. No PR / Gate 2 / live corpus ops until Ryan authorizes.
...
- **Practice-site bug triage (2026-07-06):** Codex-audited 84 findings from `logs/2026-07-05-code-review-findings.md` organized into execution tiers by impact and dependency. Start with Tier 0 (dead code & orphan data). Full plan: [`WILLOWYHOLLOW-BUG-TRIAGE-2026-07-06.md`](WILLOWYHOLLOW-BUG-TRIAGE-2026-07-06.md). Practice only.
