...
**Updated:** 2026-08-30 (Arc Unbroken Key Corrective IV FAIL; local Corrective V candidate exists)

- **[Arc Unbroken Key] R2b Corrective IV exact-tip review FAILED; Corrective V local-only (2026-08-30, Copilot audit → Cursor):** Who/What: Copilot independently reviewed draft PR #252 at immutable CI-green tip `6b5a8f9e441d028bafe8d586ec91199c3ecca219` against base `e930ae4c2fb67eabbfa570f7caacda8d9ddac79d`; Cursor subsequently created unreviewed local Corrective V commit `20d7f567184500c33c9c82eb0d1c4d90fe6bc5f2`. When: after Corrective IV semantic implementation and bounded lint repair. Why: ordinary imported Python must not manufacture or preserve trusted I1-I3 authority outside continuously held canonical writer-gate possession. How: Corrective IV preserves genuine kernel-lock-loss invalidation but leaves capability reconstruction, closure registry mutation, stale implementation binding, and filename-trusted mutation sinks. The Corrective V branch `fix/2026-08-30-2026-08-30-r2b-v2-corrective-v` is local-only; its remote still points to `e930ae4`, it has no PR, and Copilot has not reviewed it. **Resume state:** `IN_PROGRESS`; confirm single-writer ownership, stabilize and push Corrective V, obtain CI-green immutable bytes, then request fresh Copilot review. Kiro, merge, activation, live authority, and I4-I8 remain blocked until Copilot PASS. Evidence: [`COPILOT-2026-08-30-r2b-corrective-iv-fail-handoff.md`](COPILOT-2026-08-30-r2b-corrective-iv-fail-handoff.md) · [`STATUS-r2b-capture-auth.md`](../plans/STATUS-r2b-capture-auth.md).
