...
- **CG-2 `1222b1e` review provenance — COMPLETE on plan branch (2026-08-15):** Who/What: Cursor hygiene landed the orphan feasibility and evidence reviews that were only on side branches (`docs/2026-08-14-cg2-feasibility-review` @ `5eb7eac`, `docs/2026-08-14-cg2-crush-feasibility-handoff` @ `ded7bc2`). When: merged to `plan/2026-08-14-cg2-production-activation` @ `a259a40`. Why: delta confirmation @ `e680ce8` superseded both reviews but the underlying `PASS WITH RISKS` records were not on the plan branch. How: copied with supersession banners; linked from [`CURSOR-2026-08-15-cg2-delta-confirmation.md`](CURSOR-2026-08-15-cg2-delta-confirmation.md) and [`STATUS-cg2-production-activation.md`](../plans/STATUS-cg2-production-activation.md). Orphan side branches deleted.
