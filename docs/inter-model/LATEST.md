...
**Updated:** 2026-08-30 (Naturalistic G5 review complete; gate C corrective required)
...
- **[Arc Naturalistic ConvMem product-value evaluation] G5 LANDED / METHODOLOGY GATE C / G6 CLOSED (2026-08-30):** Who/What: Claude found that G5's `run_g5_end_to_end()` can label `T0_T2` successful with an incomplete prospective frame; ChatGPT withdrew the prior narrow PASS and set **C — corrective required**. G5 remains landed via [PR #259](https://github.com/alanmz-crypto/convmem/pull/259) at `6843bbeebbaed6a109fe94967fdd03fb3569b583`; the earlier Kiro PASS at `23b2495927a9891070c7c294e45bdb641eaab352` remains historical exact-tip evidence. When: after the independent methodology review required by Ryan's G6 lock. Why: treatment-dependent evaluability, incomplete prospective state, and scorer/form leakage can invalidate a later product conclusion even when isolated validators pass. How: Codex Sol retained architecture judgment and delegated a Luna-high T9 falsification pass; both recommend one bounded corrective amendment before code. **Resume state:** `BLOCKED_ON_RYAN`. **Next:** Ryan decides the six methodology choices in the corrective handoff and may then authorize Codex planning. No G5 corrective implementation, G6/T0, parameter freeze, natural evidence, Agent A/B, scoring, or product interpretation. Evidence: [corrective handoff](CODEX-2026-08-30-naturalistic-g5-methodology-corrective-handoff.md) · [`STATUS-naturalistic-product-value.md`](../plans/STATUS-naturalistic-product-value.md)
