...
- **CodeQL Complex Therapy — KIRO SHA-LINEAGE PASS; RYAN EXECUTE GATE OPEN (2026-08-16, `plan/2026-08-16-codeql-complex-therapy`):** Who/What: Kiro independently verified the planning package lineage and scope. When: exact carrier `b7c0895f7e158c30a90b77d9b211cf3a640d9438`; documented package `c74c7f8611ac0bf563618270c2c3244715df7d67` is its confirmed ancestor. Why: the transient `9dfaa6722...` wrong-SHA incident and `790d5fd2...` correction required independent verification before any execution decision. How: Kiro confirmed the 18-commit branch delta is planning docs only and returned PASS; Ryan still controls two separate Execute grants. Existing accepted decisions remain: all-three CodeQL contexts, inherited GHAS semantics, blanket latency, exact negative-control fixture, conditional producer probe, and `OWNER=Ryan` recurring attestation with quarterly plus configuration-drift cadence. [`CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md`](CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md) · [`ARCHITECTURE-codeql-complex-therapy.md`](../plans/ARCHITECTURE-codeql-complex-therapy.md) · [`EXECUTION-codeql-complex-therapy.md`](../plans/EXECUTION-codeql-complex-therapy.md) · [`VERIFY-codeql-complex-therapy.md`](../plans/VERIFY-codeql-complex-therapy.md) · [`STATUS-codeql-complex-therapy.md`](../plans/STATUS-codeql-complex-therapy.md). **Resume state:** `KIRO SHA-LINEAGE PASS + ALL POLICY DECISIONS ACCEPTED` — Execute authorization remains open.
