...
**Updated:** 2026-08-22 (Recovery Authority Execution Plan ready for Kiro; T3 remains CLOSED)

- **[Arc Recovery Authority] Execution Plan READY FOR KIRO (2026-08-22):** Who/What: Codex converted the locked Recovery Authority direction into four bounded serial Cursor tasks plus one genuinely **BLOCKED** V4k task. When: after Ryan locked architecture bytes `22852a07e66920874045e0e85c4572ab6c0b29b8` on branch `plan/2026-08-22-recovery-authority` (carrier tip `a133629f96cc34c4df2fda2730b5bcb272d743da`); final review-package tip is `8add9a7c9bd78bec3ee71e1d471eade707c9802f`. Why: V4g–V4j and V4l need separate executable boundaries and evidence, while V4k must wait for CG-2 Design A ratification and stable generation/pointer semantics. How: T1 v3 profile/registry substrate → T2 authority/projection state machine → T3 scratch-only bulk workflow → T4 recovery crash closure; the companion VERIFY maps onto existing V4/V8/V6/V7 rows without forking them. **Execute remains NOT AUTHORIZED; no implementation, migration, restore, activation, live mutation, T3 reopening, or T5 campaign occurred.** Next: Kiro Execution Plan review → Ryan. Evidence: [`EXECUTION-recovery-authority.md`](../plans/EXECUTION-recovery-authority.md) · [`VERIFY-recovery-authority.md`](../plans/VERIFY-recovery-authority.md) · [`CODEX-2026-08-22-recovery-authority-execution-planning-handoff.md`](CODEX-2026-08-22-recovery-authority-execution-planning-handoff.md).
