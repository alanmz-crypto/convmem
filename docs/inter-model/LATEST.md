...
- **LATEST stale-handoff autonomy — Kiro decision (2026-08-14, awaiting review):** Does Crush update+commit+push `LATEST.md` autonomously when the brief flags it stale, or only locally? Plus a one-line fix so `HANDOFF-TEMPLATE.md` (fixed scaffolding) stops raising a false-positive stale-handoff P0. [`KIRO-2026-08-14-latest-stale-handoff-autonomy.md`](KIRO-2026-08-14-latest-stale-handoff-autonomy.md)
