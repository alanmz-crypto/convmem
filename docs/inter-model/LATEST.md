...
- **CodeQL Complex Therapy — SHA-BOUND HARDENING HANDOFF READY FOR KIRO/Ryan REVIEW (2026-08-16, `plan/2026-08-16-codeql-complex-therapy`):** Who/What: Codex added producer-identity rejection, an explicit GitHub server-side mediation boundary, recurring-attestation requirements, a path-scoped latency alternative, and a mandatory independent SHA-lineage review after a transient handoff typo. When: review package is full SHA `c74c7f8611ac0bf563618270c2c3244715df7d67`; planning evidence remains Protect Main `19156572` and PR #197 head `740424884f8921f1586f6b82648a0a290be40836`; no implementation or disposable PR exists. Why: the plan must test integration-id binding, distinguish one-time evidence from continuous enforcement, and require Git-based identity verification rather than trusting pasted SHA strings. How: Kiro reviews the named package, independently resolves the fetched remote carrier, and records the `9dfaa...` typo / `790d...` correction; Ryan has accepted the all-three context set, inherited GHAS `CodeQL` semantics, blanket latency, and the exact disposable fixture authorization, and still must decide attestation, Execute, and producer-probe authorization. [`CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md`](CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md) · [`ARCHITECTURE-codeql-complex-therapy.md`](../plans/ARCHITECTURE-codeql-complex-therapy.md) · [`EXECUTION-codeql-complex-therapy.md`](../plans/EXECUTION-codeql-complex-therapy.md) · [`VERIFY-codeql-complex-therapy.md`](../plans/VERIFY-codeql-complex-therapy.md) · [`STATUS-codeql-complex-therapy.md`](../plans/STATUS-codeql-complex-therapy.md). **Resume state:** `CONTEXT + GHAS + BLANKET LATENCY + DISPOSABLE FIXTURE ACCEPTED` — producer probe, attestation, and Execute authorization remain open.
