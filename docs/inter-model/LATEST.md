...
**Updated:** 2026-08-21 (CG-2 V8a/V8b PASS; Arc Trapdoor Hunt closed-T3 main integration candidate; Runway Ledger CLOSED)
...
- **CG-2 authority migration — MERGED (#186); V8a PASS; V8b grant PASS; soak ACCEPTED; V8c PENDING:** Who/What: T1–T5 on `main` (`2f427fc`); Kiro V8a independent sign-off PASS (subject `2f427fc`, preservation on `451f523`); soak completion Ryan-accepted 2026-08-21. Why: gateway proven; independent review closed. How: see VERIFY V8a row + soak-completion evidence. **Resume state:** next governed step is **V8c first-owner packet preparation** only — **not** authorized for first owner, fence/pointer publication, activation manifest, GC, Shadow, or R2b. Desktop checklist: `~/Desktop/CG2-after-soak-checklist.md` (not in repo).
