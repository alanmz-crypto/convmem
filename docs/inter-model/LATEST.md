...
**Updated:** 2026-08-31 (PRE-G6 V2 architecture locked; G6 planning reconciliation in progress)

## Current routing

- **[Arc Naturalistic ConvMem product-value evaluation] PRE-G6 V2 ARCHITECTURE LOCKED / G6 PLANNING RECONCILIATION (2026-08-31, Ryan):** Who/What: Ryan architecture-locked PRE-G6 Contract V2 at commit `9f4791c2744c02d742fdb9c0fa1e9dd150591ac1` on branch `fix/2026-08-31-naturalistic-pre-g6-v2-firewall-corrective` (canonical digest `917ad129a4f9641f65b809e143467b1f2c48ea41203166365b8e3efd459b627e`, 47,330 JCS bytes). When: after Luna EXACT-BYTE PASS on firewall corrective. Why: V2 is architecture authority; G6 planning prose must project locked bytes before implementation planning. How: canonical JSON is SSoT; Cursor reconciling planning docs on `docs/2026-08-31-naturalistic-g6-v2-reconcile`. **Does not authorize G6, T0, implementation, Agent A/B, evidence collection, scoring, or product disposition.** **Resume state:** `IN_PROGRESS` (planning-doc reconciliation). **Next:** independent planning-doc review → bounded implementation-plan/grant → Ryan approval. Evidence: [`STATUS-naturalistic-product-value.md`](../plans/STATUS-naturalistic-product-value.md).
...
- **[Arc Naturalistic ConvMem product-value evaluation] G5 LANDED / PRE-G6 V2 LOCKED (2026-08-30–31):** Who/What: G5 on `main` via PR #259; PRE-G6 V2 locked @ `9f4791c`. When: G5 merged 2026-08-30; V2 locked 2026-08-31. Why: methodology dry-run complete; V2 is architecture authority. How: synthetic dry-run only — not product evidence. **G6/T0 NOT AUTHORIZED.** Supersedes prior "await ChatGPT G6 review" routing. Evidence: [`STATUS-naturalistic-product-value.md`](../plans/STATUS-naturalistic-product-value.md)
