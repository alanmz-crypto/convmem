...
- **CodeQL Complex Therapy — GRANT A AUTHORIZED; GRANT B WITHHELD (2026-08-16, `plan/2026-08-16-codeql-complex-therapy`):** Who/What: Kiro independently verified the planning package lineage and scope; Ryan now authorizes Cursor only for the `Protect Main` `19156572` patch and normal five-check positive control. When: Kiro’s exact carrier was `b7c0895f7e158c30a90b77d9b211cf3a640d9438`; the current planning record remains docs-only. Why: execution is split so ruleset mutation and positive evidence are completed before any disposable testing. How: Cursor must fresh-capture the three CodeQL identities, stop before PATCH on any name/producer mismatch, preserve the existing ruleset, and prove all five checks green and ordinarily merge-eligible. Disposable workflow testing, producer probing, and related cleanup require a separate Grant B after that proof. [`CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md`](CODEX-2026-08-16-codeql-complex-therapy-planning-handoff.md) · [`ARCHITECTURE-codeql-complex-therapy.md`](../plans/ARCHITECTURE-codeql-complex-therapy.md) · [`EXECUTION-codeql-complex-therapy.md`](../plans/EXECUTION-codeql-complex-therapy.md) · [`VERIFY-codeql-complex-therapy.md`](../plans/VERIFY-codeql-complex-therapy.md) · [`STATUS-codeql-complex-therapy.md`](../plans/STATUS-codeql-complex-therapy.md). **Resume state:** `GRANT A AUTHORIZED — RULESET + POSITIVE CONTROL ONLY` — Grant B remains withheld.
