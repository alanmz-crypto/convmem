...
| Naturalistic product-value evaluation | G1–G5 are **LANDED on `main`**, but the methodology gate remains **C — corrective required**. Ryan accepted D1–D6 as design direction; Codex committed the non-authorizing architecture/execution amendment at exact `b6a1ccf` for independent Kiro review. Prior Kiro PASS remains historical evidence only. | Kiro reviews the exact co-versioned amendment; PASS or bounded corrections return to Ryan. No G5C implementation, G6/T0, parameter freeze, natural evidence, Agent A/B, scoring, or product interpretation. See the [Kiro review handoff](CODEX-2026-08-30-naturalistic-g5-corrective-kiro-review-handoff.md) and [`STATUS-naturalistic-product-value.md`](../plans/STATUS-naturalistic-product-value.md). |
...
**TL;DR:** [Arc cross-project rollup] `main` is `b3709b2`; Naturalistic G1–G5
is landed but gate C remains open, with corrective amendment `b6a1ccf` awaiting
Kiro review and every implementation/live step closed. Recovery/CG-2 remain
non-live, R2b remains Ryan-gated after Corrective VII review, and Portland is
