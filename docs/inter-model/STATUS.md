...
| Claude Watch Parity | Ryan assigned a separate arc on 2026-09-18. Gate 1 on-demand adapter is approved but not on this planning base; the incremental substrate landed on `main` via PR #307 (`d657767`). Gate 2 plan is on `plan/2026-09-18-claude-watch-parity`; no Claude isolated spec or live canary exists. | Kiro reviews the [Gate 2 plan](CODEX-2026-09-18-claude-watch-parity-gate2-execute.md) on its exact tip. Cursor implementation requires Gate 1 and a later bounded Ryan Execute grant. Live-source canary and production watch promotion are separate Ryan gates. See [`STATUS-claude-watch-parity.md`](../plans/STATUS-claude-watch-parity.md). |
...
**TL;DR [Arc Claude Watch Parity]:** the new Claude arc has a Gate 2 plan ready
for Kiro review. Gate 1 adapter implementation, an exact-source canary, and
production watch promotion remain separate steps and grants. Verify
