...
**TL;DR:** Arc Codex's P2 runtime-readiness corrective is on
`feat/2026-09-12-codex-jsonl-p2-runtime-readiness` awaiting exact-tip Kiro
review. No PR, live Gate 0/P2, grant digest, or activation.
