...
| CG-2 production activation | CG-1 merged; CG-2 architecture draft on `plan/2026-08-14-cg2-production-activation`; ChatGPT advisory dispositions integrated; production remains legacy | Kiro/Crush exact-revision architecture review + Cursor feasibility review, then formal model and Ryan Architecture HITL. No execution planning, implementation, gateway soak, or owner activation yet. See [`STATUS-cg2-production-activation.md`](../plans/STATUS-cg2-production-activation.md). |
