...
**TL;DR:** Closed T3 is in draft main-integration PR #221 without reopening deferred work; Chroma is GREEN; Pinwheel, CodeQL, and Runway Ledger are CLOSED; CG-2 has V8a PASS plus soak completed/accepted (V8c first-owner packet PENDING, not authorized); JudgeBench awaits Ryan's calibration-experiment grant and G4; Shadow waits on activation evidence then Ryan grant; R2b waits on a fresh authorization packet.
