...
| Naturalistic product-value evaluation | G1–G5 **LANDED on `main`** (G5 via PR #259 at `6843bbeebbaed6a109fe94967fdd03fb3569b583`). Methodology validation complete; not product evidence. Arc brief: [`STATUS-naturalistic-product-value.md`](../plans/STATUS-naturalistic-product-value.md). | Ryan explicit **G6 grant** for prospective study freeze, or park arc. No Agent A/B, episode collection, live ConvMem, threshold freeze, or product conclusion without G6+. |
