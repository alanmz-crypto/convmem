...
**Corpus note:** Canonical repo path remains [`../plans/EXECUTION-2026-07-21-source-trust-ranking.md`](../plans/EXECUTION-2026-07-21-source-trust-ranking.md). This inter-model copy exists so `convmem search` / Codex shared-memory can retrieve the full execution plan (plans/ is not an ingest adapter).
