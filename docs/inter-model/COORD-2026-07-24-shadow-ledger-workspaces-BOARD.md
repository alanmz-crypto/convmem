...
> **GitHub snapshot:** Copied from
> `/tmp/convmem-coord-2026-07-24-workspaces/BOARD.md` during Round 3 salvage
> so takeover does not depend on `/tmp`. Live appends may continue under `/tmp`
> until Ryan closes coordination; prefer GitHub after this PR lands.

**Topic:** Shadow Ledger Phase 0 + related leftovers (research-pack / audit / PR #115)  
**Prompts:** `PROMPT-ROUND-*-workspace-coord.md` / `PROMPT-ROUND-3-SALVAGE-TO-GITHUB.md` (same `docs/inter-model/` dir on this salvage branch)  
