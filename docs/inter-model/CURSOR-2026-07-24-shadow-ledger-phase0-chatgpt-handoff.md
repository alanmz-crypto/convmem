...
> **Supersession (2026-07-24 salvage):** Codex already authored draft Architecture
> PR [#115](https://github.com/alanmz-crypto/convmem/pull/115) @ `c9a5c70`.
> Keep this file as provenance for the ChatGPT→Codex advice step. Do **not**
> treat it as an open request to re-author Architecture. Takeover brief:
> [`CURSOR-2026-07-24-shadow-ledger-phase0-recon-takeover.md`](CURSOR-2026-07-24-shadow-ledger-phase0-recon-takeover.md).
