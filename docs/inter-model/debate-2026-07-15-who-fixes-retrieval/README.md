...
| 2 | `ask(trace=True)` + source diversification (trace-gated) | **Open** — Cursor top-two filed; partners file `<LANE>-top-two-problems-and-plans.md` here, then conflict review |
