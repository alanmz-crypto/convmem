...
**Status:** **Shipped** on `main` via [PR #40](https://github.com/alanmz-crypto/convmem/pull/40) @ `20fc85d` (partner PASS @ `2c7e599`). Canonical archive copy.
...
3. Code PR — **done** (characterization → extract → no-LLM retrieve test; partner PASS; merged).
4. **Next arc:** retrieval-eval rewrite against `RetrievalBundle.trace` / bundle fields.
