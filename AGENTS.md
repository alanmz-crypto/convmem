...
- [`docs/plans/STATUS-chroma-upsert-crash.md`](docs/plans/STATUS-chroma-upsert-crash.md) — Arc Poison Pill: convmem indexer SIGSEGV / Chroma upsert crash (**active**; Phase C′ blocked on a Ryan platform gate)
