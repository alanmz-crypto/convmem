...
- [`docs/plans/STATUS-generalize-append-cursor.md`](docs/plans/STATUS-generalize-append-cursor.md) — Arc Codex append-cursor format extension (**Kiro planning PASS; Ryan Execute pending**)
