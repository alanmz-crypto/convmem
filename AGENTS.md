...
- [`docs/plans/STATUS-recovery-authority.md`](docs/plans/STATUS-recovery-authority.md) — Recovery Authority execution planning (**Kiro review pending; Execute unauthorized**)
