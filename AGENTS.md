...
- [`docs/plans/STATUS-naturalistic-product-value.md`](docs/plans/STATUS-naturalistic-product-value.md) — Naturalistic ConvMem product-value evaluation (**G1–G4 landed; G5 not authorized**)
