...
- [`docs/plans/STATUS-generalize-append-cursor.md`](docs/plans/STATUS-generalize-append-cursor.md) — Arc Codex append-cursor format extension (**planning draft; Kiro review and Ryan Execute pending**)
