...
| [`docs/inter-model/CROSS-PROJECT-DIGEST-PILOT.md`](inter-model/CROSS-PROJECT-DIGEST-PILOT.md) | Manual pilot log — runs 2–3 done, run 4 pending |
...
**Not the same track:** ROADMAP **P1c** (ask streaming on timeout) is orthogonal — see [`docs/ROADMAP-DRAFT.md`](docs/ROADMAP-DRAFT.md) and `dec_prop_20260629_213047_8f73`.
...
- Global protocol: see [`docs/inter-model/VERIFICATION-MATRIX.md`](inter-model/VERIFICATION-MATRIX.md) and [`docs/inter-model/CONTINUE-VERIFY.md`](inter-model/CONTINUE-VERIFY.md) for current surface status (Qwen Continue lane closed 2026-06-29; alien-workspace habit still uneven on some models)
...
Pre-Qwen-close snapshot; newer Continue headless rows in [`SOAK-REPORT-2026-06-25.md`](inter-model/SOAK-REPORT-2026-06-25.md) (#19–#22).
...
5. For global protocol / Continue verify handoff use [`docs/inter-model/LATEST.md`](inter-model/LATEST.md)
